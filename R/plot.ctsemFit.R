...
#'
#' Plots \code{\link[ctsemOMX]{ctMultigroupFit}} objects.
#' 
#' @param x ctsemMultigroupFit object as generated by \code{\link[ctsemOMX]{ctMultigroupFit}}
#' @param group character string of subgroup to plot. Default of 'show chooser' displays list and lets you select.
#' @param ... additional parameters to pass to \code{\link[ctsemOMX]{plot.ctsemFit}} function.
...
#' For more customization possibilities, see \code{\link[ctsemOMX]{ctPlot}}.
#' 
#' @param x ctsemFit object as generated by \code{\link[ctsemOMX]{ctFit}}.
