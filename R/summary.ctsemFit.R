...
#'
#' Provides summary details for objects fitted with \code{\link[ctsemOMX]{ctMultigroupFit}}.
#' 
#' @param object ctsemMultigroupFit object as generated by \code{\link[ctsemOMX]{ctMultigroupFit}}
...
#' @param ... additional parameters to pass to \code{\link[ctsemOMX]{summary.ctsemFit}}.
...
#' @details Important: Although \code{\link[ctsem]{ctModel}} takes cholesky decomposed variance-covariance matrices as input,
...
#' Standard errors are displayed in the $ctparameters section, however if \code{\link[ctsemOMX]{ctFit}} was used with transformedParams=TRUE (the default, and recommended) 
#' covariance matrix standard errors will have been approximated using the delta method. For 
#' inferential purposes, maximum likelihood confidence intervals may be estimated using the \code{\link[ctsemOMX]{ctCI}} function.
#' @examples 
